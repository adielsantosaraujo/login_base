...
- [x] 1.1 Adicionar ao `pom.xml` `spring-boot-starter-flyway` e `org.flywaydb:flyway-database-postgresql` (versões do BOM do Boot) e verificar que `./mvnw -q -DskipTests package` compila
